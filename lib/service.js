...
Service.prototype.interview = function(cb) {
  ...
  return new Promise(function(resolve, reject) {
    _this.util.exec('ndm interview', {cwd: _this.installDirectory}, function() {
      resolve();
    });
  }).nodeify(cb);
};
...
Service.prototype.installServices = function(cb) {
  var _this = this,
    command = 'ndm generate --uid=' + this.user + ' --gid=' + this.group;
...
Service.prototype.installPackages = function(cb) {
  var _this = this,
    command = 'npm install --always-auth --registry=' + this.registry;
